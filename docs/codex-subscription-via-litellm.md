...
GPT-5.4 mini, GPT-5.5, GPT-5.6 Luna, GPT-5.6 Terra, GPT-5.6 Sol, and GPT-6 Astra as
`litellm/gpt-5.4`, `litellm/gpt-5.4-mini`, `litellm/gpt-5.5`,
`litellm/gpt-5.6-luna`, `litellm/gpt-5.6-terra`, `litellm/gpt-5.6-sol`, and
`litellm/gpt-6-astra`, assigns concurrent sessions across healthy sidecars, and
...
GPT-5.4 mini, GPT-5.5, GPT-5.6 Luna, GPT-5.6 Terra, GPT-5.6 Sol, and GPT-6 Astra use the same frozen Responses
translation, tool policy, and output budgets. GPT-5.4 mini compacts at 300k to
fit its 400k context; the large-context models compact at 900k:
