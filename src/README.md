...
- **uniform_strategy** — one shared planner (≤80k) enumerates up to eight distinct strategies, then eight fresh executors receive one assigned strategy each. `baseline-uniform-strategy` is one complete 8× bank.
