...
LATE_CONTINUATION_PROMPT_FILE: str = "late_continuation.md"
...
META_MUSE_SPARK_CONTRIBUTOR_MODEL: str = "muse-spark-1.2-contributor"
META_BASE_URL: str = "https://api.meta.ai"
META_API_KEY_ENV: str = "META_API_KEY"
